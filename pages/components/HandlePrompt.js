export default function HandlePrompt({textInput, onChange, onSubmit, waiting, selectVal, selectChange, TextPrompt, egArray, temperature, setTemperature, maxtokens, setMaxtokens }) {
    return (
